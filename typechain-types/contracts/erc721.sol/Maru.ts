...
export interface MaruInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Maru extends BaseContract {
  connect(runner?: ContractRunner | null): Maru;
  waitForDeployment(): Promise<this>;

  interface: MaruInterface;

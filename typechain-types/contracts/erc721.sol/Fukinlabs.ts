...
export interface FukinlabsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface Fukinlabs extends BaseContract {
  connect(runner?: ContractRunner | null): Fukinlabs;
  waitForDeployment(): Promise<this>;

  interface: FukinlabsInterface;
